...
class Fandom(Scrapper):
    ...
    def __init__(self, url:str=f"https://%?.fandom.com/wiki/", page="<pagename>" ):
        super().__init__(url.replace('%?', page))
        self.data=None


    def filter_valid_planet_name(self, planet_name:str) -> bool:
    ...
    def scrap(self, debug:bool=False):
        ...
        # scrapping for every pages associate to the list of planet names
        data = []
